...
- Devise a way for the politician to acheive this goal.
...
\vfill
We can also think about transition probabilities from state $i$ to state $j$. Create a 5 X 5 table with these probabilities.
...
Consider this in the context of a hiker and a mountain - how might this algorithm work?
 
\newpage
 
### Metropolis Sampler for Beta Prior and Bernoulli likelihood

We will soon use JAGS for fitting Bayesian models, but these algorithms can also be written directly in R code.
