...
- We will extend the free throw shooting idea from earlier by using free throw shooting for NBA players. 
\vfill
...
- Let $\omega$ be a parameter that describes free throw ability for players based on their position and let $\theta$ be a player specific parameter for free throw shooting ability.
...
\vfill
Let $y_i =1$ if the $i^{th}$ free throw is made and 0 otherwise. 
\vfill
\vfill
...
-Again, we are interested in the joint posterior distribution, $p(\theta, \omega|\mathcal{D})$. 
